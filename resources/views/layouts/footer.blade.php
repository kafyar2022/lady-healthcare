<footer class="container main-footer">
  ...
  <dl class="footer-contacts">
    <dt class="footer-contacts__term">{{ $mainTexts['footer-address-title'] }}</dt>
    <dd class="footer-contacts__item" data-action="reset-map">{{ $mainTexts['address'] }}</dd>
    <dt class="footer-contacts__term">{{ $mainTexts['footer-contacts-title'] }}</dt>
