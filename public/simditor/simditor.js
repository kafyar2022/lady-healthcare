...
Simditor.i18n = {
  ...
  'ru-RU': {
    ...
    'code': 'Код',
    'color': 'Цвет текста',
    'coloredText': 'Цветной текст',
    'hr': 'Горизонтальная линия',
    'image': 'Вставить изображение',
    'externalImage': 'Внешнее изображение',
    'uploadImage': 'Загрузить изображение',
    'uploadFailed': 'Загрузка не удалась',
    'uploadError': 'Ошибка возникает во время загрузки',
    'imageUrl': 'Адрес',
    'imageSize': 'Размер',
    'imageAlt': 'Альтернативный текст',
    'restoreImageSize': 'Восстановить исходный размер',
    'uploading': 'Загрузка',
    'indent': 'Отступ',
    'outdent': 'Выступающий',
    'italic': 'Курсив',
    ...
    'linkUrl': 'Адрес',
    'linkTarget': 'Окно',
    'openLinkInCurrentWindow': 'Открыть ссылку в текущем окне',
    ...
    'fontScaleXLarge': 'Очень большой размер',
    'fontScaleLarge': 'Большой размер',
    'fontScaleNormal': 'Нормальный размер',
    'fontScaleSmall': 'Маленький размер',
    'fontScaleXSmall': 'Очень маленький размер'
  }
};
